        ...
        <div class="col-span-full">
          ...
          <div class="mt-2">
            <textarea id="body"  name="body" rows="3"
             class=" {{ $errors->has('body') ? 'outline-red-500' : 'outline-gray-300' }}block w-full rounded-md bg-Black/5 px-3 py-1.5 text-base text-Black outline-1 -outline-offset-1  placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6">
             {{ old('body', $post->body )}}
            </textarea>
          </div>
          ...
          <div class="flex gap-3">
              <div class="flex h-6 shrink-0 items-center">
                <div class="group grid size-4 grid-cols-1">
                  ...
                  name="published" value="1"  {{ old('published') || (!old() && $post->published) ? 'checked' : '' }} aria-describedby="Published-description"
